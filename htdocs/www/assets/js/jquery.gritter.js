(function ($) {
    ...
    $.gritter = {
        ...
        add: function (o) {
            ...
            $.gritter.createGrowl(o);
        },

        createGrowl: function (opt) {
            ...
            $(document.body).qtip({
                ...
                events: {
                    render: function (event, api) {
                        ...
                        $.gritter.timer.call(api.elements.tooltip, event);
                    }
                }
            }).removeData('qtip');
        },
    ...
    $(document).delegate('.qtip.jgrowl', 'mouseover mouseout', $.gritter.timer);
